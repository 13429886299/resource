...
!function (t, e) {
    ...
    var He = function (a, u) {
        return function (t) {
            ...
            var n = t.parent, i = function (t) {
                if (!P(t)) return !1;
                var e = "^" === t.charAt(0);
                return {val: e ? t.substring(1) : t, root: e}
            }(e.url), o = i ? a.compile(i.val, {state: e}) : e.url;
            if (!o) return null;
    ...
    var Qe = function () {
        ...
        return t.prototype._matchingNodes = function (t, e, r) {
            ...
            var u = this, s = L(this._getDefaultMatchCriteria(), this.matchCriteria);
    ...
    var Ye = function () {
        ...
        return t.prototype.buildHooksForPhase = function (t) {
            ...
            var a = this.transition, t = a.treeChanges(), e = this.getMatchingHooks(o, t, a);
            if (!e) return [];
            ...
            var t = e.hookPhase === d.TransitionHookPhase.CREATE, i = this.transition.router.transitionService;
    ...
    var tn, en, rn, nn = function () {
        ...
        return (tn = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
    ...
    }(nn), un = (en = function (t, e) {
        return (en = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            for (var r in e) e.hasOwnProperty(r) && (t[r] = e[r])
        })(t, e)
    ...
    }(nn), cn = (rn = function (t, e) {
        return (rn = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            for (var r in e) e.hasOwnProperty(r) && (t[r] = e[r])
        })(t, e)
    ...
    Nn = ["$uiRouter", "$timeout", function (h, p) {
        ...
        var S = {$cfg: {viewDecl: {$context: i._pluginapi._rootViewContext()}}, $uiView: {}}, $ = {
            count: 0, restrict: "ECA", terminal: !0, priority: 400, transclude: "element", compile: function (t, e, y) {
